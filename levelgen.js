...
function floor() {
    ...
    var vector2 = new THREE.Vector2(5,100);
    ...
    wallr1 = new THREE.Mesh(new THREE.PlaneGeometry(vector2.x,vector2.y), new THREE.MeshPhongMaterial({color: 0xffffff, wireframe:false}));
    wallr1.rotation.z = - Math.PI/2;
    wallr1.rotation.y = - Math.PI/2;
    wallr1.position.z = - vector2.y/2.2;
    wallr1.position.x = vector2.x/2;
    scene.add(wallr1);
    ...
    wallr2 = new THREE.Mesh(new THREE.PlaneGeometry(vector2.x,vector2.y), new THREE.MeshPhongMaterial({color: 0xffffff, wireframe:false}));
    wallr2.rotation.z = - Math.PI/2;
    wallr2.rotation.y = - Math.PI/2;
    wallr2.position.z = - vector2.y/2.2  - vector2.y;
    wallr2.position.x = vector2.x/2;
    scene.add(wallr2);
}
